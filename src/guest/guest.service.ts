...
export class GuestService {
  ...
  async update(
    ...
    const guestData = {
      ...
      avatarUrl:
        updatedGuest.avatarUrl !== undefined ? updatedGuest.avatarUrl : null,
    };
  ...
  async remove(id: string): Promise<ApiResponseType> {
    ...
    const deletedGuest = await this.guestModel
    ...
    const guestData = {
      ...
      avatarUrl:
        deletedGuest.avatarUrl !== undefined ? deletedGuest.avatarUrl : null,
    };
